...
namespace ChromeHtmlToPdfLib.Helpers.Sanitizer
{
    ...
    internal class HtmlSanitizer
    {
        ...
        {
            get => _disallowedCssPropertyValue ?? DefaultDisallowedCssPropertyValue;
        ...
        /// </value>
        public ISet<string> AllowedCssClasses { get; }
        #endregion
        ...
        private static HtmlParser CreateParser()
        {
            ...
            //return new HtmlParser(options, new BrowsingContext();
        }
        #endregion
        ...
        #region DoSanitize
        public void DoSanitize(IHtmlDocument dom, IElement context, string baseUrl = "")
        {
        ...
        #region SanitizeStyleSheets
        private void SanitizeStyleSheets(IDocumentStyle dom, string baseUrl)
        {
        ...
        #region SanitizeStyleDeclaration
        ...
        protected Iri GetSafeIri(string url)
        {
            ...
            if (schemeMatch.Success)
            {
                ...
                return Enumerable.Contains(AllowedSchemes, scheme, StringComparer.OrdinalIgnoreCase)
                    ? new Iri {Value = url, Scheme = scheme}
                    : null;
            }
